<?php
	...
	// find customer
	$customerid = getCustomerId($name,$username,$email,$ph, $address, $city, $zip_code,$country,$gn,$pass);
	if($customerid == null) {
		// insert customer into database and return customerid
		$customerid = setCustomerId($name,$username,$email,$ph, $address, $city, $zip_code,$country,$gn,$pass);
	}
